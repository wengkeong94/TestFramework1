...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Walter Wong" => "walter.wwk@grabtaxi.com" }
  # Or just: spec.author    = "Walter Wong"
  # spec.authors            = { "Walter Wong" => "walter.wwk@grabtaxi.com" }
  # spec.social_media_url   = "https://twitter.com/Walter Wong"
